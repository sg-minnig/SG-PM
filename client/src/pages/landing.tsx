...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-pink-400 via-purple-400 to-indigo-400 dark:from-pink-600 dark:via-purple-600 dark:to-indigo-600">
      {/* Header */}
      <header className="px-8 py-6 border-b border-white/20 backdrop-blur-sm bg-white/10">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            />
            <h1 className="text-xl font-semibold text-white">ChapterOps</h1>
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center space-y-12">
          <div className="space-y-6">
            <h2 className="text-5xl md:text-6xl font-bold tracking-tight text-white drop-shadow-lg">
              ...
              <span className="block text-yellow-200 mt-2">Executive Transition</span>
            </h2>
          ...
          <div className="flex items-center justify-center gap-4">
            <Button size="lg" onClick={handleLogin} className="text-lg px-8 bg-white text-purple-600 hover:bg-white/90" data-testid="button-get-started">
              Get Started
            </Button>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-16">
            <Card className="border-0 shadow-lg bg-white/95 backdrop-blur">
              <CardContent className="pt-8 pb-6 text-center space-y-4">
                <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-purple-100 mx-auto">
            ...
            <Card className="border-0 shadow-lg bg-white/95 backdrop-blur">
              <CardContent className="pt-8 pb-6 text-center space-y-4">
                <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-indigo-100 mx-auto">
            ...
            <Card className="border-0 shadow-lg bg-white/95 backdrop-blur">
              <CardContent className="pt-8 pb-6 text-center space-y-4">
                <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-pink-100 mx-auto">
      ...
      {/* Footer */}
      <footer className="px-8 py-6 border-t border-white/20 backdrop-blur-sm bg-white/10">
        <div className="max-w-7xl mx-auto text-center text-sm text-white/80">
